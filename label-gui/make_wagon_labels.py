...
class Barcode:
    ...
    def __init__(self, payload):
        ...
        self.majortype = payload[4:6]
        self.subtype = payload[6:-5]
        self.first = payload[:4]
        self.type = payload[4:-5]
    ...
    def get_nickname(self):
        ...
        self.nickname = labels[str(self.majortype) + str(self.subtype)]
...
def produce_barcode(barcode, x_offset=0, y_offset=0):
    ...
    l.origin(9.6, 1.25)
    l.write_text(barcode.type, char_height=2, char_width=2, line_width=7.25, orientation='B', justification='C')
    l.endorigin()
    ...
    l.origin(12, 1.8)
    l.write_text("LD Wagon", char_height=3, char_width=3, line_width=40, orientation='N', justification='L')
    l.endorigin()
...
if __name__ == "__main__":
    ...
    barcode = Barcode("3205WW30A200001")
